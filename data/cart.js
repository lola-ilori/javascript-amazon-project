...
loadFromStorage(); //call the function to load the cart array from local storage

export function loadFromStorage() {
  cart = JSON.parse(localStorage.getItem('cart')); //get the cart array from local storage.
